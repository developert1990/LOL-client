export const runes = [{
    ...
    "slots": [{
        ...
        "runes": [{
            ...
            "longDesc": "Begin the game with a Commencing Stopwatch that transforms into a Perfectly Timed Stopwatch after 14 minutes. Each takedown you acquire reduces this timer by 120 seconds.<br><br>Perfectly Timed Stopwatch can be used for a one time 2.5 second Stasis effect."
        }]
    }, {
        "runes": [{
            "id": 8321,
    ...
    "slots": [{
        "runes": [{
            ...
            "name": "Conqueror",
            "shortDesc": "Gain stacks of adaptive force when attacking enemy champions. After reaching 10 stacks, heal for a portion of damage you deal to champions.",
    ...
    "slots": [{
        ...
        "runes": [{
            ...
            "name": "Conditioning",
            "shortDesc": "After 10 min gain +9 Armor and +9 Magic Resist and increase your Armor and Magic Resist by 5%.",
            "longDesc": "After 10 min gain +9 Armor and +9 Magic Resist and increase your Armor and Magic Resist by 5%."
        }, {
            "id": 8444,
            "key": "SecondWind",
    ...
    "slots": [{
        "runes": [{
            ...
            "longDesc": "Hitting an enemy champion with 3 attacks or <b>separate</b> abilities within 4s grants 25 - 40% Movement Speed based on level and 75% Slow Resistance. <br><br>Movement speed is increased to 30 - 50% for Melee champions.<br><br>Duration: 3s<br>Cooldown: 15s"
        }]
    }, {
        "runes": [{
            "id": 8224,
            ...
            "longDesc": "After casting a Summoner Spell, gain a movement speed increase that lasts for 2.5s and allows you to pass through units.<br><br>Increase: 15% - 35% Movement Speed based on the Summoner Spell's cooldown. (Higher cooldown Summoner Spells grant more Movement Speed). "
        }]
    }, {
        "runes": [{
            "id": 8210,
