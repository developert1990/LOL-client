export const items = {
    ...
    "data": {
        ...
        "3031": {
            "name": "Infinity Edge",
            "description": "<mainText><stats><attention> 70</attention> Attack Damage<br><attention> 20%</attention> Critical Strike Chance</stats><br><li><passive>Perfection:</passive> If you have at least 60% Critical Strike Chance, gain 35% Critical Strike Damage.</mainText><br>",
            "colloq": ";ie",
        ...
        "3082": {
            "name": "Warden's Mail",
            "description": "<mainText><stats><attention> 40</attention> Armor</stats><br><li><passive>Rock Solid:</passive> Reduce incoming damage from Attacks by up to (0.5% max Health), capped at 40% of the attack's damage.</mainText><br>",
            "colloq": "",
            "plaintext": "",
            "from": [
                "1029",
        ...
        "3152": {
            ...
            "description": "<mainText><stats><attention> 90</attention> Ability Power<br><attention> 350</attention> Health<br><attention> 15</attention> Ability Haste</stats><br><br> <active>Active -</active> <active>Hex Bolt:</active> Dash in target direction, unleashing an arc of magic missiles that deal <magicDamage>(125 +15% Ability Power) magic damage</magicDamage>. Then, gain <speed>30% Move Speed</speed> towards enemy champions for 1.5 seconds (40s cooldown).<br><br><rarityMythic>Mythic Passive:</rarityMythic> Grants all other <rarityLegendary>Legendary</rarityLegendary> items <attention> 5</attention> Magic Penetration.<br><br><rules>Supersonic's dash cannot pass through terrain.</rules></mainText><br>",
            "colloq": "rocket belt;",
        ...
        "3191": {
            ...
            "description": "<mainText><stats><attention> 20</attention> Ability Power<br><attention> 15</attention> Armor</stats><br><li><passive>Witch's Path:</passive> Killing a unit grants <scaleArmor>1 Armor</scaleArmor> (max <scaleArmor>30</scaleArmor>).</mainText><br>",
            "colloq": ";",
        ...
        "3508": {
            "name": "Essence Reaver",
            "description": "<mainText><stats><attention> 55</attention> Attack Damage<br><attention> 20%</attention> Critical Strike Chance<br><attention> 20</attention> Ability Haste</stats><br><li><passive>Spellblade:</passive> After using an Ability, your next Attack is enhanced with an additional <physicalDamage>(100% base Attack Damage + 40% bonus Attack Damage) physical damage</physicalDamage> and restores 40% of this damage as <scaleMana>Mana</scaleMana> (1.5s cooldown).</mainText><br>",
            "colloq": ";",
        ...
        "4629": {
            "name": "Cosmic Drive",
            "description": "<mainText><stats><attention> 75</attention> Ability Power<br><attention> 200</attention> Health<br><attention> 30</attention> Ability Haste</stats><br><li><passive>Spelldance:</passive> Dealing damage with Abilities grants <speed>(10 + 20% Ability Haste) Move Speed</speed> for 4 seconds.</mainText><br>",
            "colloq": "",
        ...
        "4641": {
            ...
            "description": "<mainText><stats></stats><li><passive>Arcane Cache:</passive> This item can store up to 3 purchased Control Wards.<li><passive>Blooming Empire:</passive> This item transforms into <rarityLegendary>Watchful Wardstone</rarityLegendary> once 20 Stealth Wards have been placed.<br><br><rules>Stealth Wards are placed from the Stealth Ward Trinket and the upgraded <attention>Unique: Support</attention> items.</rules><br><br></mainText><br>",
            "colloq": "",
            "plaintext": "",
            "consumed": true,
            "consumeOnFull": true,
        ...
        "4643": {
            ...
            "description": "<mainText><stats><attention> 40</attention> Ability Haste<br><attention> 10%</attention> Move Speed</stats><br><li><passive>Arcane Cache:</passive> This item can store up to 3 purchased Control Wards.<li><passive>Behold:</passive> Increase your Stealth Ward and Control Ward placement caps by 1.<br><br><rules>Requires <rarityLegendary>Watchful Sightstone</rarityLegendary> to purchase.</rules></mainText><br>",
            "colloq": "",
            "plaintext": "",
            "from": [
                "4638"
        ...
        "6035": {
            ...
            "description": "<mainText><stats><attention> 35</attention> Attack Damage<br><attention> 200</attention> Health<br><attention> 35</attention> Magic Resist</stats><br><br> <active>Active -</active> <active>Quicksilver:</active> Remove all crowd control debuffs (excluding <status>Airborne</status>) and gain 40% Tenacity and 40% Slow Resistance for 3 seconds (90s cooldown).</mainText><br>",
            "colloq": "",
            "plaintext": "",
            "from": [
                "3140",
        ...
        "6631": {
            "name": "Stridebreaker",
            "description": "<mainText><stats><attention> 45</attention> Attack Damage<br><attention> 20%</attention> Attack Speed<br><attention> 300</attention> Health<br><attention> 20</attention> Ability Haste</stats><br><br> <active>Active -</active> <active>Halting Slash:</active> Lunge a short distance and deal <physicalDamage>(100% Attack Damage) physical damage</physicalDamage> to nearby enemies, <status>Slowing</status> them by 60%, decaying over 2 seconds (20s cooldown, reduced by Ability Haste).<br><li><passive>Heroic Gait:</passive> Dealing physical damage grants <speed>30 Move Speed</speed> for 2 seconds.<br><br><rarityMythic>Mythic Passive:</rarityMythic> Grants all other <rarityLegendary>Legendary</rarityLegendary> items <attention> 3%</attention> Move Speed.<br><br><rules>Halting Slash's dash cannot pass through terrain.</rules></mainText><br>",
            "colloq": "",
            "plaintext": "",
            "from": [
                "6029",
        ...
        "6653": {
            ...
            "description": "<mainText><stats><attention> 80</attention> Ability Power<br><attention> 600</attention> Mana<br><attention> 20</attention> Ability Haste</stats><br><li><passive>Torment:</passive> Dealing damage with Abilities causes enemies to burn for <magicDamage>(15 + 1.5% Ability Power) + 1% max Health magic damage</magicDamage> per second for 4 seconds. Whilst burning, they lose <scaleMR>5% Magic Resist</scaleMR> per second (max reduction <scaleMR>15%</scaleMR>).<br><br><rarityMythic>Mythic Passive:</rarityMythic> Grants all other <rarityLegendary>Legendary</rarityLegendary> items <attention> 5</attention> Ability Haste.</mainText><br>",
            "colloq": "",
        ...
        "6673": {
            ...
            "description": "<mainText><stats><attention> 50</attention> Attack Damage<br><attention> 15%</attention> Attack Speed<br><attention> 20%</attention> Critical Strike Chance<br><attention> 12%</attention> Life Steal</stats><br><li><passive>Lifeline:</passive> When taking damage that would reduce you below 30% Health, gain a <shield>250 - 700 Shield</shield> for 3s. In addition, gain <lifeSteal>15% Life Steal</lifeSteal> for 8s (90s cooldown).<br><br><rarityMythic>Mythic Passive:</rarityMythic> Grants all other <rarityLegendary>Legendary</rarityLegendary> items <attention> 5</attention> Attack Damage and <attention> 50</attention> Health.</mainText><br>",
            "colloq": "",
            "plaintext": "",
            "from": [
                "6670",
        ...
        "6695": {
            "name": "Serpent's Fang",
            "description": "<mainText><stats><attention> 55</attention> Attack Damage<br><attention> 18</attention> Lethality</stats><br><li><passive>Shield Reaver:</passive> Attacks and spells deal (70 + 40% bonus Attack Damage) additional physical damage to <shield>Shielded</shield> targets.<br><br><rules>Additional damage not applied to targets with shields that only block magic damage.</rules></mainText><br>",
            "colloq": "",
            "plaintext": "",
            "from": [
                "3134",
